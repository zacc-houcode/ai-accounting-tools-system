...
| 🤖 AI Agent 团队建造器 | 部门长期用的那一支团队：6 个现成 Agent（指挥、连接、流程、技能、训练、Plugin 打包），再加上你自己的岗位。「✨ AI 帮你建 Agent」跟流程建造器一样：复制提示词 → 贴进你自己的 Claude → 把 JSON 贴回来，卡片自动建好。导出 `AI-TEAM-SYSTEM.md` |
